 ...
 * @version 1.0.0
 */
public abstract class BaseSwipeRefreshPagerLoaderFragment<T extends BasePresenter> extends BasePagerLoaderFragment<T> implements SwipeRefreshLayout.OnRefreshListener{
